...
class FastCarAlarmConsumer:
    def __init__(self, app:FastAPI, db:DatabaseManagementService) -> None:
        self.topic_name = "event.rule_violation_task"
        self.db = db
    ...
    def broadcast(self, event_data: dict, raw_data_tracker:str):
        ...
        if "rule_violation_task" not in event_data or len(event_data["rule_violation_task"]) == 0:
        ...
        if "rule_violation_task" in event_data:
            ...
            for aa in event_data["rule_violation_task"]:
