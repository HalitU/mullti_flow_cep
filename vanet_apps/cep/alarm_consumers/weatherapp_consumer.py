...
class WeatherAppConsumer:
    ...
    def broadcast(self, event_data: dict, raw_data_tracker:str):
        ...
        if "air_quality_task" not in event_data or len(event_data["air_quality_task"]) == 0:
        ...
        if "air_quality_task" in event_data:
            ...
            for aa in event_data["air_quality_task"]:
