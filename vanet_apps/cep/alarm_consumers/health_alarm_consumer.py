...
class HealthAlarmConsumer:
    def __init__(self, app:FastAPI, db:DatabaseManagementService) -> None:
        self.topic_name = "event.health_alarm_task"
        self.db = db
    ...
    def broadcast(self, event_data: dict, raw_data_tracker:str):
        ...
        if "health_alarm_task" not in event_data or len(event_data["health_alarm_task"]) == 0:
        ...
        if "health_alarm_task" in event_data:
            ...
            for aa in event_data["health_alarm_task"]:
