...
def vehicle_type_detection_task(data):
    res:List[str] = []
    ...
    data_priority = 1 if ambulance_exists else 0
    return {"vehicle_type_detection_task": {"vehicles": ["ambulance", "truck"], "load":artifical_load}}, ambulance_exists, False, data_priority
