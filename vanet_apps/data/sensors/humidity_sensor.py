...
class HumiditySensor(BaseDataSensor):
    def __init__(self, 
        ...
        print(f"[HumiditySensor] Initializing with params: {sdp.msg_per_delay}, {sdp.default_delay_s}")
    ...
    def run(self):    
        ...
        while not stop:
            ...
            for _ in range(count_per_delay):
                ...
                self.producer.send(data, raw_data_tracker="humidity_data")
