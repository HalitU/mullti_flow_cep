...
class StatsFileHelper:
    def __init__(self, app:FastAPI, header_arr:list[str], endpoint_prefix:str, endpoint_name:str) -> None:
    ...
    def register_stat_endpoints(self):
        ...
        def _():
            print(f"{configs.env_host_name}...requested to send the file: {self.stats_file}....{self.file_name}")
