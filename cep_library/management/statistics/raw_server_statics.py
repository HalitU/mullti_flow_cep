...
class RawServerStatAnalyzer:
    ...
    def normalize_get_expected_load_per_second(self, host_name:str, topic_name:str, remote:bool) -> float:
        if configs.EXPECTED_LOAD_TYPE == 1:
            value:float = self.get_expected_load_per_second(host_name, topic_name, remote)
            return self.normalize(self.minc, self.maxc, value)
        else:
            raise Exception("Invalid load type detected!")
    
    def get_expected_load_per_second(self, host_name:str, topic_name:str, remote:bool) -> float:
        if configs.EXPECTED_LOAD_TYPE == 1:
            expected_count_per_sec = self.get_expected_event_count(host_name, topic_name)
    ...
    def get_expected_event_count(self, host_name:str, topic_name:str) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            if self.raw_stats[host_name][topic_name].get_calculated():
                return self.raw_stats[host_name][topic_name].get_per_second_expected_event_count()
        return 5.0
    
    def update_raw_stats(self, rawstats:List[RawStatisticsBook]) -> None:
        for rs in rawstats:
            if rs.get_calculated():
                if configs.UPDATE_LATEST_STATS and rs.producer_name in self.raw_stats and rs.topic_name in self.raw_stats[rs.producer_name]:
    ...
    def set_stat_min_max(self, host_name:str, topic_name:str, minx:float, maxx:float) -> None:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            self.raw_stats[host_name][topic_name].minx = minx
            self.raw_stats[host_name][topic_name].maxx = maxx

    def get_avg_byte_mul_ns(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
    ...
    def normalized_get_avg_byte_mul_ns(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_byte_mul_ns(remote)
    ...
    def get_avg_byte_mul_ns_square(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].get_avg_byte_mul_ns_square(remote)
    ...
    def normalized_get_avg_byte_mul_ns_square(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_byte_mul_ns_square(remote)
        
        default_val:TopicStatBase = TopicStatBase()
        for _, ts in self.raw_stats.items():
            for _, stat in ts.items():
                default_val.add_value(stat.normalized_get_avg_byte_mul_ns_square(remote))
        return default_val.get_default_val()


    def normalized_get_avg_byte_over_n(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_byte_over_n(remote)
    ...
    def get_avg_byte_over_n(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
    ...
    def normalized_get_avg_byte_over_ns(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_byte_over_ns(remote)
    ...
    def get_avg_byte_over_ns(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
    ...
    def normalized_get_cp_sat_cost(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_cp_sat_cost(remote)
    ...
    def normalized_get_avg_ns_over_byte(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_ns_over_byte(remote)
    ...
    def get_avg_ns_over_byte(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
    ...
    def normalized_get_avg_ns_over_n(self, host_name:str, topic_name:str, remote:bool) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_avg_ns_over_n(remote)
    ...
    def normalized_get_write_size_byte_total(self, host_name:str, topic_name:str) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_write_size_byte_total()
    ...
    def get_remote_write_time_byte_mean(self, host_name:str, topic_name:str) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].get_remote_write_time_byte_mean()
    ...
    def normalized_get_write_time_ns_total(self, host_name:str, topic_name:str) -> float:
        if host_name in self.raw_stats and topic_name in self.raw_stats[host_name]:
            return self.raw_stats[host_name][topic_name].normalized_get_write_time_ns_total()
